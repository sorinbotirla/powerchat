...
var OperatorChat = function(){
    ...
    _self.waiters = {};
    _self.repeaters = {};
    _self.websocketUrl = "dev.powerlaptop.ro"; // THE WEBSOCKET SERVER URL
    _self.apiUrl = "https://dev.powerlaptop.ro/powerchat/"; // THE index.php URL
    _self.attachmentsUrl = "https://dev.powerlaptop.ro/powerchat/attachments/"; // THE attachments folder URL
